...
export const routes: RouteDefinition[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: lazy(() => import("@pages/auth/activateAccount")),
      },
    ],
  },
  {
    ...
    children: [
      { path: "", component: lazy(() => import("@pages/app/main")) },
      {
        ...
        component: lazy(() => import("@pages/app/main/folder")),
      ...
      },
      {
        ...
        component: lazy(() => import("@pages/app/main/favorites")),
        matchFilters: { noteId: isUUID },
      },
      {
        path: "/archived/:noteId?",
        component: lazy(() => import("@pages/app/main/archived")),
        matchFilters: { noteId: isUUID },
      },
      {
        path: "/trash/:noteId?",
        component: lazy(() => import("@pages/app/main/trash")),
        matchFilters: { noteId: isUUID },
      },
    ],
  },
