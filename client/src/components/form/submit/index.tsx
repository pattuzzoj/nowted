...
export default function Submit(props: SubmitProps) {
  ...
  return (
    <button {...attrs} class="p-2 rounded-lg bg-accent cursor-pointer hover:bg-accent/70 flex justify-center active:bg-accent disabled:opacity-50 group" type="submit" disabled={local.active}>
